...
class ProdutoController
{
    ...
    public function store(): void
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            // A MÁGICA AQUI: Uma única função salva o produto e os tamanhos na mesma linha da tabela!
    ...
    // Rota que recebe os dados do Modal de Edição
    public function update(): void
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $this->produtoModel->atualizar($id, $nome, $descricao, $preco, $categoria_id, $imagem_nome, $tem_tamanhos, $preco_p, $preco_m, $preco_g);
