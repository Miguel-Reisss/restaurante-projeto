...
class Pedido {
    ...
    public function salvarItem($id_pedido, $id_produto, $quantidade, $subtotal, $nome)
    {
        // Agora estamos enviando o 'nome' para o banco também!
        $sql = "INSERT INTO itens_pedido (id_pedido, id_produto, quantidade, subtotal, nome) VALUES (?, ?, ?, ?, ?)";
        $stmt = $this->conn->prepare($sql);
        return $stmt->execute([$id_pedido, $id_produto, $quantidade, $subtotal, $nome]);
    }
