...
<body>
    ...
    <div class="container" style="max-width: 1200px;">
        ...
        <?php if (empty($produtos)): ?>
            <div class="text-center py-5">
                <h4 class="text-muted">Cardápio em atualização</h4>
                <p class="text-muted">O administrador ainda não cadastrou nenhum produto.</p>
            </div>
        <?php endif; ?>

        <?php foreach ($categorias as $cat): ?>
            <?php if (isset($cardapioAgrupado[$cat['id']])): ?>
                ...
                <div class="row g-4 justify-content-center mb-4">
                    <?php foreach ($cardapioAgrupado[$cat['id']] as $p): ?>
                        <div class="col-12 col-md-6 col-lg-4">
                            ...
                            <div class="produto-card <?= $p['tem_tamanhos'] ? 'dinâmico' : '' ?>" data-nome-base="<?= htmlspecialchars($p['nome']) ?>">
                                ...
                                <?php if ($p['tem_tamanhos']): ?>
                                    ...
                                    <div class="preco">R$ <?= number_format((float)($p['preco_m'] ?: $p['preco_p']), 2, ',', '.') ?></div>
    ...
    <script>
        ...
        // ==========================================
        // LÓGICA PARA OS CARDS COM SELECT (Tamanhos)
        // ==========================================
        ...
        function atualizarTelaTotal() {
            ...
            document.querySelectorAll('.qtd-numero').forEach(span => {
                ...
                if (nome) {
                    span.innerText = carrinho[nome] ? carrinho[nome].qtd : 0;
                }
            });
