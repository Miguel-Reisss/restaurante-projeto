...
<body>
  ...
  <div class="header mb-4" style="background-color: #2B2D42; color: white; padding: 15px 20px; display: flex; justify-content: space-between; align-items: center;">
        
        <div></div> <h4 class="mb-0 fw-bold"><i class="ph ph-receipt"></i> Gestão de Pedidos</h4>
        
        <a href="index.php?controller=pedido&action=limparEntregues" class="btn btn-danger btn-sm" onclick="return confirm('Apagar todos os pedidos já entregues?')">
            <i class="ph ph-broom"></i> Limpar Entregues
        </a>
    </div>
